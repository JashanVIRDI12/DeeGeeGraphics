...
import { Image, Maximize, Palette, ArrowRight, Mail, Phone, CheckCircle } from 'lucide-react'
...
function WallMurals() {
  ...
  const features = [
    {
      ...
      description: "Transform your space with stunning custom wall murals. High-resolution printing on premium materials."
    },
    {
      icon: <Maximize className="w-8 h-8" />,
      title: "Wide Format Printing",
      description: "Large format printing services for banners, posters, and displays up to 60 inches wide."
    },
    {
      icon: <Palette className="w-8 h-8" />,
      title: "Vibrant Colors",
      description: "State-of-the-art printing technology ensures vibrant, long-lasting colors that won't fade."
    }
  ]
  ...
  const services = [
    {
      name: "Wall Murals",
      description: "Custom wall murals for homes, offices, and commercial spaces",
      features: ["Custom design service", "High-resolution printing", "Easy installation", "Removable options"],
      image: "photo-1586023492125-27b2c045efd7"
    },
    {
      name: "Wide Format Banners", 
      description: "Large format banners for events, trade shows, and advertising",
      features: ["Weather resistant", "Various materials", "Grommets included", "Fast turnaround"],
      image: "photo-1560472354-b33ff0c44a43"
    },
    {
      name: "Poster Printing",
      description: "High-quality poster printing in various sizes",
      features: ["Multiple paper options", "Lamination available", "Custom sizes", "Bulk discounts"],
      image: "photo-1634128221889-7e994fb8fb34"
    },
    {
      name: "Trade Show Displays",
      description: "Professional displays for exhibitions and trade shows",
      features: ["Portable designs", "Easy setup", "Professional graphics", "Carrying cases"],
      image: "photo-1540575467063-178a50c2df87"
    },
    {
      name: "Retail Signage",
      description: "Eye-catching retail signs and displays",
      features: ["Point of sale displays", "Window graphics", "Floor decals", "Promotional signs"],
      image: "photo-1441986300917-64674bd600d8"
    },
    {
      name: "Architectural Graphics",
      description: "Large-scale graphics for buildings and structures",
      features: ["Building wraps", "Architectural films", "Decorative panels", "Wayfinding signs"],
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Wall Murals and Wide Format Printing",
    "description": "Professional wall murals and wide format printing services in Caledon and Toronto. Custom wall murals, large format banners, posters, and architectural graphics.",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Wall Murals and Wide Format Printing Services",
  ...
  return (
    <>
      <SEO 
        title="Wall Murals & Wide Format Printing | Custom Wall Graphics | Caledon & Toronto"
        description="Professional wall murals and wide format printing in Caledon and Toronto. Custom wall graphics, large format banners, posters, trade show displays. Transform your space today!"
        keywords="wall murals, wide format printing, custom wall graphics, large format printing, wall murals Caledon, wall murals Toronto, wide format banners, poster printing, trade show displays, architectural graphics, retail signage"
        canonicalUrl="/services/wall-murals"
          ...
          <div className="relative z-10 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto w-full py-20">
            <div className="text-center max-w-5xl mx-auto">
                ...
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-tight tracking-tight" style={{ color: '#0F172A' }}>
                  <div className="block md:hidden">
                    <div className="whitespace-nowrap mb-2">
                      {'Wall Murals &'.split('').map((char, index) => (
                        <span key={index} className="char inline-block">{char === ' ' ? '\u00A0' : char}</span>
                      ))}
                    </div>
                    <div className="whitespace-nowrap">
                      {'Wide Format'.split('').map((char, index) => (
                        <span key={index} className="char inline-block">{char === ' ' ? '\u00A0' : char}</span>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="hidden md:block">
                    ...
                    <div className="whitespace-nowrap">
                      {'Wide Format Printing'.split('').map((char, index) => (
                        <span key={index} className="char inline-block">{char === ' ' ? '\u00A0' : char}</span>
                      ))}
                    </div>
                  </div>
              ...
              <p ref={descriptionRef} className="text-lg md:text-xl mb-10 leading-relaxed max-w-4xl mx-auto" style={{ color: '#64748B' }}>
                Transform your space with stunning wall murals and wide format printing services in Caledon and Toronto. Custom wall graphics, large format banners, posters, and architectural displays that make a lasting impression.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-6xl font-black mb-6" style={{ color: '#0F172A' }}>
                Why Choose Our Wide Format Printing?
              </h2>
              <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#64748B' }}>
                Professional wall murals and wide format printing with exceptional quality and service
              </p>
            </div>
        ...
        <section id="services-section" className="py-32 relative overflow-hidden" style={{ backgroundColor: '#FFFFFF' }}>
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            <div className="text-center mb-20">
              ...
              <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#64748B' }}>
                Comprehensive large format printing solutions for all your needs
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto text-center px-6 sm:px-8 lg:px-12 relative z-10">
            <div className="mb-12">
              <h2 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight">
                ...
                <br />
                <span className="bg-gradient-to-r from-gray-300 to-white bg-clip-text text-transparent">Custom Wall Murals</span>
              </h2>
              
              <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
                Get professional wall murals and wide format printing in Caledon and Toronto. Contact us today for a free consultation and quote.
              </p>
            </div>
