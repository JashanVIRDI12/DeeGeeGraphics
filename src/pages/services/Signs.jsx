...
import { Store, Lightbulb, Shield, ArrowRight, Mail, Phone, CheckCircle } from 'lucide-react'
...
function Signs() {
  ...
  const features = [
    {
      ...
      description: "Eye-catching storefront signs that enhance your brand presence and attract customers to your business."
    },
    {
      icon: <Lightbulb className="w-8 h-8" />,
      title: "Channel Letters",
      description: "Illuminated channel letters for maximum visibility day and night. Professional LED lighting solutions."
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Durable Materials",
      description: "Weather-resistant signs built to last. Premium materials ensure your investment stands the test of time."
    }
  ]
  ...
  const signTypes = [
    {
      ...
      description: "Illuminated 3D letters for maximum visibility and professional appearance",
      features: ["LED lighting", "Weather resistant", "Custom fonts", "Energy efficient"],
      image: "photo-1441986300917-64674bd600d8"
    },
    {
      name: "Storefront Signs", 
      description: "Complete storefront signage solutions to enhance your business presence",
      features: ["Custom design", "Professional installation", "Various materials", "Permit assistance"],
      image: "photo-1560472354-b33ff0c44a43"
    },
    {
      name: "Outdoor Signs",
      description: "Durable outdoor signage for businesses, events, and promotions",
      features: ["Weather proof", "UV resistant", "Multiple sizes", "Ground stakes included"],
      image: "photo-1586953208448-b95a79798f07"
    },
    {
      name: "Indoor Signs",
      description: "Professional indoor signage for offices, retail, and commercial spaces",
      features: ["ADA compliant options", "Wayfinding signs", "Directory boards", "Custom graphics"],
      image: "photo-1634128221889-7e994fb8fb34"
    },
    {
      name: "Monument Signs",
      description: "Impressive monument signs for business complexes and developments",
      features: ["Stone and metal options", "Integrated lighting", "Landscaping integration", "Permit handling"],
      image: "photo-1540575467063-178a50c2df87"
    },
    {
      name: "Pylon Signs",
      description: "Tall pylon signs for maximum visibility from roadways",
      features: ["High visibility", "Multiple tenant options", "LED displays available", "Professional engineering"],
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Signs and Channel Letters",
    "description": "Professional signs and channel letters in Caledon and Toronto. Custom storefront signs, illuminated channel letters, outdoor signs, and monument signs.",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Signs and Channel Letters Services",
      "itemListElement": signTypes.map(sign => ({
        "@type": "Offer",
        "itemOffered": {
          "@type": "Service",
          "name": sign.name
  ...
  return (
    <>
      <SEO 
        title="Signs & Channel Letters | Storefront Signs | LED Signs | Caledon & Toronto"
        description="Professional signs and channel letters in Caledon and Toronto. Custom storefront signs, illuminated channel letters, outdoor signs, monument signs. Boost your business visibility!"
        keywords="signs, channel letters, storefront signs, outdoor signs, LED signs, monument signs, pylon signs, business signs, signs Caledon, signs Toronto, illuminated signs, custom signs, professional signage"
        canonicalUrl="/services/signs"
      ...
      <div className="min-h-screen bg-black">
          ...
          <div className="relative z-10 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto w-full py-20">
            <div className="text-center max-w-5xl mx-auto">
              ...
              <p ref={descriptionRef} className="text-lg md:text-xl mb-10 leading-relaxed max-w-4xl mx-auto" style={{ color: '#64748B' }}>
                Professional signs and channel letters in Caledon and Toronto. Custom storefront signs, illuminated channel letters, and outdoor signage solutions that boost your business visibility and attract more customers.
              </p>
              ...
              <div ref={ctaRef} className="flex justify-center">
                <button 
                  ...
                  onClick={() => document.querySelector('#signs-section')?.scrollIntoView({ behavior: 'smooth' })}
                >
                  <span>Explore Sign Options</span>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-6xl font-black mb-6" style={{ color: '#0F172A' }}>
                Why Choose Our Sign Services?
              </h2>
              <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#64748B' }}>
                Professional signage solutions that enhance your brand and drive business growth
              </p>
            </div>
        ...
        {/* Sign Types Section */}
        <section id="signs-section" className="py-32 relative overflow-hidden" style={{ backgroundColor: '#FFFFFF' }}>
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-6xl font-black mb-6" style={{ color: '#0F172A' }}>
              ...
              <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: '#64748B' }}>
                Complete range of signage services for businesses of all sizes
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto text-center px-6 sm:px-8 lg:px-12 relative z-10">
            <div className="mb-12">
              <h2 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight">
                ...
                <br />
                <span className="bg-gradient-to-r from-gray-300 to-white bg-clip-text text-transparent">Professional Signs</span>
              </h2>
              
              <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
                Get professional signs and channel letters in Caledon and Toronto. Contact us today for a free consultation and custom quote.
              </p>
            </div>
